...
Relación que indica que un registro en la tabla A puede tener varios registros relacionados en la tabla B, pero un registro en la tabla B se relaciona con un sólo registro en la tabla A.
*/
...
Relación que indica que un un registro en la tabla A puede relacionarse con varios registros en la tabla B y viceversa. Requiere una tabla intermedia o de unión para establecer la relación.
*/
...
-- El campo user_id y language_id de la tabla intermedia "users_languages" es clave foránea de las claves primarias user_id de la tabla "users" y de language_id de la tabla "languages" Un usuario puede conoces muchos lenguajes. Un lenguaje puede ser conocido por muchos usuarios.
...
/*
Relación de Auto-Referencia Relación que indica que un un registro en la tabla A puede relacionarse con otro registro de la tabla A.
*/
...
INSERT INTO dni (dni_number, user_id) VALUES (123343111, 7);
INSERT INTO dni (dni_number, user_id) VALUES (22343422, 8);
INSERT INTO dni (dni_number, user_id) VALUES (33343433, 9);
...
UPDATE users SET company_id = 1 WHERE user_id = 8;
UPDATE users SET company_id = 2 WHERE user_id = 10;
UPDATE users SET company_id = 3 WHERE user_id = 11;
UPDATE users SET company_id = 1 WHERE user_id = 12;
...
INSERT INTO users_languages (user_id, language_id) VALUES (10, 5);
INSERT INTO users_languages (user_id, language_id) VALUES (4, 5);
INSERT INTO users_languages (user_id, language_id) VALUES (4, 3);
INSERT INTO users_languages (user_id, language_id) VALUES (5, 5);
